...
You can play with the latest version at [coolingtool.github.io/tiers](https://coolingtool.github.io/tiers), or you can download the repository and open `index.html` in your browser (in both cases, all the logic is run locally on your browser).

#### Features
- Give a title to your tierlist
- Import any number of pictures from your local disk and from a url
